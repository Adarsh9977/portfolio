        ...
        <section ref={ref} id="home" className="z-20 mt-32 scroll-mt-36">
            <div className="container">
                <div className="flex justify-center items-center">
                    ...
                    className="text-xl sm:text-3xl md:text-4xl  text-white text-center py-10 my-5 max-w-[690px] tracking-wider">
                        <span className="font-bold">I'm Adarsh.</span>I&apos;m a{" "} <br />
                        <span className="font-bold z-20"><FlipWords duration={2000} className="text-[#beedf9] font-bold text-2xl sm:text-4xl md:text-5xl" words={roles}/></span><br/>with{" "}
                ...
                >
                    <div className="bg-gradient-to-r from-[#fd9fa2] to-[#7d70e2] p-0.5 rounded-full z-20">
                        ...
                        >
                            <button className="text-white flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base bg-gray-700 group p-1 sm:p-2 rounded-full font-semibold">
                    ...
                    <div className="bg-gradient-to-r from-[#fbb0b2] to-[#9f92ff] p-0.5 rounded-full hover:scale-105 ease-linear cursor-pointer z-20">
                        <a
                        className="flex relative items-center justify-center gap-1 sm:gap-2 text-center cursor-pointer p-1 sm:p-2 text-xs sm:text-sm md:text-base z-30 bg-clip-content rounded-full text-black font-semibold"
                    ...
                    target="_blank"
                    className="bg-white rounded-full z-20 p-1 sm:p-2 hover:bg-white/70 cursor-pointer">
                        <FaGithubSquare size={30}/>
                    </a>
                    <a
                    href="https://www.linkedin.com/in/adarsh-tiwari-b9a64a19a" 
                    target="_blank"
                    className="bg-white rounded-full p-1 sm:p-2 z-20 hover:bg-white/70 cursor-pointer">
                        <FaLinkedin size={30}/>
                    </a>
                </motion.div>
            </div>
